...
<?php 
  ...
  if (isset($_GET['show_product_samsung'])) {
   ...
   echo '<script>window.location = "search.php?searchTaplet"</script>';
  }
?>
...
<form id="form1" name="form1" method="post" >
  <div id="tfheader">
		<form id="tfnewsearch" method="post" action="Tapletpage.php">
...
<div class="ShowHit">
<div class="hit1"><img src="thit-02.jpg" width="300" height="200" alt=""/></div>
 <div class="hit2"><img src="thit-01.jpg" width="335" height="200" alt=""/></div>
...
<?PHP
       if(isset($_POST['search2'])){
		echo '<script>window.location = "search.php?tapmax-min";</script>';
		}
		if(isset($_POST['search1'])){
		echo '<script>window.location = "search.php?tapmin-max";</script>';
		}
?>
