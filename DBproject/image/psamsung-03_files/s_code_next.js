...
s.linkInternalFilters="JAVA-SCRIPT:,tel:,www.samsung.com,japan.samsung.com,2.samsung.com,3.samsung.com,4.samsung.com,shop.samsung.com,store.samsung.com,local.sec.samsung.com,ru.samsung.com,eu.samsung.com"; 
...
function getPid(data){
	...
	s.linkTrackVars = "eVar6,eVar9,eVar39,eVar40,eVar7";
	...
	/*
	if (siteCd.indexOf('tw') != -1 || siteCd.indexOf('ru') != -1){
		s.linkTrackEvents='none';
		//s.linkTrackVars="eVar7";
		s.eVar7 = data.toLowerCase();
		s.tl(this, "o", "internal_campaign_tracking");
	}else{
	*/
