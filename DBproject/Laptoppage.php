...
<?php 
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'asus' and PRODUCT_TYPE = 'notebook'";
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'lenovo' and PRODUCT_TYPE = 'notebook' ";
	$parseRequest = oci_parse($conn, $query);
	oci_execute($parseRequest);
	$_SESSION['PIC_PRODUCTs']=array();
	$_SESSION['PIC_IDs']=array();
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'acer' and PRODUCT_TYPE = 'notebook'";
	$parseRequest = oci_parse($conn, $query);
	oci_execute($parseRequest);
	$_SESSION['PIC_PRODUCTs']=array();
	$_SESSION['PIC_IDs']=array();
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'samsung' and PRODUCT_TYPE = 'notebook'";
	$parseRequest = oci_parse($conn, $query);
	oci_execute($parseRequest);
	$_SESSION['PIC_PRODUCTs']=array();
	$_SESSION['PIC_IDs']=array();
  ...
  if (isset($_GET['show_product_samsung'])) {
   ...
   echo '<script>window.location = "search.php?searchLaptop"</script>';
  }
...
<body bgcolor="#F1F1F1" onload="MM_preloadImages('acer1.png','samsung1.png','lenovo1.png','asus1.png','menubarPC1.jpg')">
<div class="test">
...
<div class="tab">
  ...
  <div class="tabmen3"><a href="Laptoppage.php"><img src="menubarLAP2.jpg" width="165" height="40" alt=""/></a></div>
...
<form id="form1" name="form1" method="post" >
  <div id="tfheader">
		<form id="tfnewsearch" method="post" action="Laptoppage.php">
...
<div class="tabmenu1"><a href="Laptoppage.php?show_product_samsung=true" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','samsung1.png',1)"><img src="samsung.png" alt="" width="184" height="63" id="Image2" /></a></div>

<div class="tabmenu2"><a href="Laptoppage.php?show_product_acer=true" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','acer3.png',1)"><img src="acer2.png" alt="" width="184" height="63" id="Image12" /></a></div>

<div class="tabmenu3"><a href='Laptoppage.php?show_product_lenovo=true' onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','lenovo1.png',1)"><img src="lenovo.png" alt="" width="195" height="80" id="Image8" /></a></div>
<div class="tabmenu4" ><a href='Laptoppage.php?show_product_asus=true' onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','asus1.png',1)" ><img src="asus.png" alt="" width="184" height="63" id="Image11" /></a></div>
<div class="ShowHit">
<div class="hit1"><img src="laptophit-01.jpg" width="300" height="200" alt=""/></div>
 <div class="hit2"><img src="laptophit-02.jpg" width="350" height="200" alt=""/></div>
...
<?PHP
       if(isset($_POST['search2'])){
		echo '<script>window.location = "search.php?notebookmax-min";</script>';
		}
		if(isset($_POST['search1'])){
		echo '<script>window.location = "search.php?notebookmin-max";</script>';
		}
?>
