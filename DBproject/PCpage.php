...
<?php 
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'asus' and PRODUCT_TYPE = 'pc'";
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'lenovo' and PRODUCT_TYPE = 'pc' ";
	$parseRequest = oci_parse($conn, $query);
	oci_execute($parseRequest);
	$_SESSION['PIC_PRODUCTs']=array();
	$_SESSION['PIC_IDs']=array();
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'acer' and PRODUCT_TYPE = 'pc'";
	$parseRequest = oci_parse($conn, $query);
	oci_execute($parseRequest);
	$_SESSION['PIC_PRODUCTs']=array();
	$_SESSION['PIC_IDs']=array();
   ...
   {
    $conn = oci_connect("system", "tickey31862", "//localhost/XE");
	$query = "select PATH,ID_PIC From CPE_SHOP_PIC_PRODUCT where BRAND = 'samsung' and PRODUCT_TYPE = 'pc'";
	$parseRequest = oci_parse($conn, $query);
	oci_execute($parseRequest);
	$_SESSION['PIC_PRODUCTs']=array();
	$_SESSION['PIC_IDs']=array();
...
<body bgcolor="#F1F1F1" onload="MM_preloadImages('acer1.png','samsung1.png','lenovo1.png','asus1.png')">
<div class="test">
...
<div class="tab">
  ...
  <div class="tabmen2"><a href="PCpage.php"><img src="menubarPC1.jpg" width="165" height="40" ></a></div>
...
<form id="form1" name="form1" method="post" >
  <div id="tfheader">
		<form id="tfnewsearch" method="post" action="PCpage.php">
...
<div class="tabmenu1"><a href="PCpage.php?show_product_samsung=true" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','samsung1.png',1)"><img src="samsung.png" alt="" width="184" height="63" id="Image2" /></a></div>

<div class="tabmenu2"><a href="PCpage.php?show_product_acer=true" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','acer3.png',1)"><img src="acer2.png" alt="" width="184" height="63" id="Image12" /></a></div>

<div class="tabmenu3"><a href='PCpage.php?show_product_lenovo=true' onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','lenovo1.png',1)"><img src="lenovo.png" alt="" width="195" height="80" id="Image8" /></a></div>
<div class="tabmenu4" ><a href='PCpage.php?show_product_asus=true' onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','asus1.png',1)" ><img src="asus.png" alt="" width="184" height="63" id="Image11" /></a></div>
<div class="ShowHit">

<div class="hit1"><img src="pchit-01.jpg" width="300" height="200" ></div>
<div class="hit2"><img src="image/pc/pacer-01.jpg" width="335" height="200" /></div>
...
<?PHP
       if(isset($_POST['search2'])){
		echo '<script>window.location = "search.php?PCmax-min";</script>';
		}
		if(isset($_POST['search1'])){
		echo '<script>window.location = "search.php?PCmin-max";</script>';
		}
?>
