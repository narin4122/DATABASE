...
if (isset($_GET['out_of_stock'])) {
  echo '<script>window.alert("Sorry,Product out of stock")</script>';
...
<div class="Pname"><div class="myfont2" style="font-size:20px"><?PHP echo $_SESSION['BRAND']; ?></div></div>
<div class="Price"><div class="myfont2" style="font-size:20px"><label><?PHP echo $_SESSION['Price']; ?> BATH</label></div></div>
<div class="Ppicture"><img src="<?PHP echo $_SESSION['PATH'] ?>" height="350" width="350" /></div>
<div class="PDetail"><textarea style="height:250px; width: 300px;"><?PHP echo $_SESSION['detail'];?></textarea></div>
<div class="PBuy">
 <a href="<?PHP if($_SESSION['Price'] == null){echo "ProductDetail.php?out_of_stock";} else {echo "ConfirmOrder.php?".$_SESSION['ID'];} ?>"> <button type="button" class="btn btn-default" style="width:100px; height:40px; "><div class="myfont2" style="font-size:20px;">BUY</div></button></a>
</div>
